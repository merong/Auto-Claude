    ...
    <>
      ...
      {project.autoBuildPath && (
        <>
          ...
          {/* Agent Settings */}
          <section className="space-y-4">
            <h3 className="text-sm font-semibold text-foreground">{t('agentConfig.title')}</h3>
            <div className="space-y-2">
              <Label htmlFor="model" className="text-sm font-medium text-foreground">{t('agentConfig.model')}</Label>
              <Select
