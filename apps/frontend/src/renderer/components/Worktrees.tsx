                  ...
                  <CardContent className="pt-0">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm mb-4">
                      <div className="flex items-center gap-1.5 text-muted-foreground">
                        ...
                        <span>{t('worktrees.filesChanged', { count: worktree.filesChanged })}</span>
                      </div>
                      <div className="flex items-center gap-1.5 text-muted-foreground">
                        <ChevronRight className="h-3.5 w-3.5" />
                        <span>{t('worktrees.commitsAhead', { count: worktree.commitCount })}</span>
                      </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      >
                        ...
                        {t('worktrees.mergeTo', { branch: worktree.baseBranch })}
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    {mergeResult.conflictFiles && mergeResult.conflictFiles.length > 0 && (
                      <div className="mt-2">
                        <p className="text-xs font-medium">{t('worktrees.mergeDialog.conflictFiles')}</p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {t('worktrees.deleteDialog.cannotUndo')}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
